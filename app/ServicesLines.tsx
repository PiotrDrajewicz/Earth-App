        ...
        <div ref={setRefs} className="line-container">
            <div className="services-text-container">
                <article id='services-article-guide' className="services-article">
                    {inView1 && <motion.div style={{position: 'absolute', backgroundColor: '#F13737', left: '-280px', width: '10px', borderRadius: '50px', filter: 'drop-shadow(3px 5px 8px rgba(241, 55, 55, .3))'}} initial={{height: '0px'}} animate={{height: '90px'}} transition={{duration: 1, delay: 2.8}} />}
                ...
                <article id='services-article-transport' className="services-article">
                    {inView2 && <motion.div style={{position: 'absolute', backgroundColor: '#F13737', top: '95px', left: '590px', width: '10px', borderRadius: '50px', filter: 'drop-shadow(3px 5px 8px rgba(241, 55, 55, .3))'}} initial={{height: '0px'}} animate={{height: '75px'}} transition={{duration: 1, delay: 2.8}} />}
                ...
                <article id='services-article-dinner' className="services-article">
                    {inView3 && <motion.div style={{position: 'absolute', backgroundColor: '#F13737', top: '80px', left: '-280px', width: '10px', borderRadius: '50px', filter: 'drop-shadow(3px 5px 8px rgba(241, 55, 55, .3))'}} initial={{height: '0px'}} animate={{height: '70px'}} transition={{duration: 1, delay: 2.8}} />}
                ...
                <article id='services-article-freeTime' className="services-article">
                    {inView4 && <motion.div style={{position: 'absolute', backgroundColor: '#F13737', top: '85px', left: '590px', width: '10px', borderRadius: '50px', filter: 'drop-shadow(3px 5px 8px rgba(241, 55, 55, .3))'}} initial={{height: '0px'}} animate={{height: '75px'}} transition={{duration: 1, delay: 2.8}} />}
                ...
                <article id="services-article-souvenir" className="services-article">
                    {inView5 && <motion.div style={{position: 'absolute', backgroundColor: '#F13737', top: '80px', left: '-280px', width: '10px', borderRadius: '50px', filter: 'drop-shadow(3px 5px 8px rgba(241, 55, 55, .3))'}} initial={{height: '0px'}} animate={{height: '70px'}} transition={{duration: 1, delay: 2.8}} />}
            ...
            <svg className="lines-svg" viewBox="-3 0 116 444" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMax meet" style={{paddingTop: '20px', paddingBottom: '20px'}} filter='drop-shadow(3px 5px 8px rgba(241, 55, 55, .3))'>
